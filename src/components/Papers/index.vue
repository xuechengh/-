    ...
    <el-row class="th">
        ...
        <el-col :xs="8" :sm="3">
            ...
            <span class="caret-wrapper">
                ...
                <!-- <i class="sort-caret ascending el-icon-caret-bottom"></i> -->
            </span>
        ...
        <el-col :sm="6" :xs="6" class="hidden-xs-only">
            试卷类型
        </el-col>
...
export default {
  ...
  methods:{
    ...
    _delPaper(id){
      p.delPapers({'id':id,'pro':this.cur_pro}).then((res)=>{
      const d = res.data;
      this.tb = [];
      if(d.Code !== 0){
        this.$message.error(d.Msg);
